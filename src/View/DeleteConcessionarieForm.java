 ...
 * @author Melissa
 */
public class DeleteConcessionarieForm extends javax.swing.JFrame {
    ConcessionaireVO objVO;
    ConcessionaireDAO objDAO=new ConcessionaireDAO();
    /**
     * Creates new form DeleteConcessionarieForm
     */
    public DeleteConcessionarieForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPnlBody.add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 330, -1, -1));
        ...
        jPnlBody.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 130, 440, 170));
        ...
        jPnlBody.add(btnMostrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 330, -1, -1));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
         int filSeleccionada=this.jTableConcesionario.getSelectedRow();
         
                int valor=Integer.parseInt(jTableConcesionario.getValueAt(filSeleccionada,0).toString());
                
                System.out.println("el id es: "+valor);
                objDAO.eliminarCliente(valor);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteConcessionarieForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
