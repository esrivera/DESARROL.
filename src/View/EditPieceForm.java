 ...
 * @author Randy
 */
public class EditPieceForm extends javax.swing.JFrame {

    PieceDAO pieceDAO = new PieceDAO();
    public static String idPiece = "";
    /**
     * Creates new form EditPieceForm
     * @param id
     */
    public EditPieceForm(String id) {
        this.idPiece = id;
        initComponents();
    ...
    private void initComponents() {
        ...
        TitleView.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/Edit Pieces.png"))); // NOI18N
        ...
        EditButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/Save Button.png"))); // NOI18N
        ...
        jPnlBody.add(EditButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(228, 435, 140, 35));
        ...
        txtPieceName.setEditable(false);
    ...
    private void EditButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditButtonMouseClicked
        ...
        {
            pieceDAO.modifyPiece(Integer.parseInt(txtPieceId.getText()), txtPieceName.getText(), txtPieceCategory.getText(), txtPieceDescription.getText(),
    ...
    private void CancelButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CancelButtonMouseClicked
        ConfirmDialog dialog = new ConfirmDialog(this, true);
        dialog.dialogText.setText("Do you want to exit without saving?");
        dialog.setVisible(true);
        if(dialog.getReturnStatus()==1)
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditPieceForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
