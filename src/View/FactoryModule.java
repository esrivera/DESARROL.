 ...
 * @author Randy
 */
public class FactoryModule extends javax.swing.JFrame {

    /**
     * Creates new form FactoryModule
     */
    ...
    private void initComponents() {
        ...
        jPnlBody.add(WarehouseOption, new org.netbeans.lib.awtextra.AbsoluteConstraints(189, 103, 140, 156));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FactoryModule.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
